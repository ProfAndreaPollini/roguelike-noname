//
// original from https://github.com/pyridine/REXSpeeder
//

#ifndef RL_DA_ZERO_SRC_LIB_REXSPEEDER_H
#define RL_DA_ZERO_SRC_LIB_REXSPEEDER_H
...
struct RexTile {
    uint8_t character;
    std::array<uint8_t, 3>
        __padding;  // Do not use. Accounts for the unused final 3 bytes in .xp tile characters (v 1.03).
    uint8_t fore_red;
    uint8_t fore_green;
    uint8_t fore_blue;
    uint8_t back_red;
...
constexpr RexTile transparentTile() { return RexTile{0, 0, 0, 0, 255, 0, 255}; }
...
#endif  // RL_DA_ZERO_SRC_LIB_REXSPEEDER_H
